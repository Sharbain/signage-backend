...
.rss-item:before{content:"› ";color:#4ade80}
...
async function render(el){
  ...
  zone.className="zone";
  zone.style.cssText="left:"+p.l+"px;top:"+p.t+"px;width:"+p.w+"px;height:"+p.h+"px;"+(el.borderRadius?"border-radius:"+(el.borderRadius*p.sx)+"px;":"")+(el.zIndex!=null?"z-index:"+el.zIndex+";":"");
